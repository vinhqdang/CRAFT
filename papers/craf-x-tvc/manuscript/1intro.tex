...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/fig_perception_split.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/fig_patch_attack_scenario.png}
...
\begin{enumerate}
    ...
    \item A \textbf{Gated Adaptive Fusion Module (GAFM)} that dynamically quarantines adversarial signals at the granular grid-cell level.
