...
To ensure the highest standards of transparency and to facilitate further research in verifiable multi-modal autonomous perception, all data sets, pre-trained weights, and the full source code for the CRAF-X framework are made publicly available. The repository can be accessed via our GitHub page at \url{https://github.com/vinhqdang/CRAFT}.
